...
class AppConstants {
  ...
  static const String contextSubtitle = 'Help us tailor wine recommendations for your business dinners';
  static const String budgetLabel = 'Typical Bottle Budget (HKD)';
  static const String occupationLabel = 'Your Occupation / Industry';
  static const String occupationHint = 'e.g., ESG Consultant, Investment Banking';
  static const String saveContextButton = 'Save Context';
  
  // Scanner Screen
  static const String scannerTitle = 'Scan Wine';
  static const String scannerSubtitle = 'Take a photo of the wine label or menu';
  ...
  static const String emptyVaultMessage = 'No wines scanned yet. Start building your vault!';
  ...
  // Budget Ranges
  static const List<int> budgetOptions = [
    200,
    500,
    1000,
    2000,
  ...
  // API
  static const String kimiApiUrl = 'https://api.moonshot.cn/v1/chat/completions';
